...
## How to Use
1. On your phone (or desktop), create a node with the `#Ask Tana` tag. You can get it from [this](https://app.tana.inc/shared/ask-tana/RjBOTmxrTEFVQkFrL0lJbG5qX1NTMzI5Mw==) template.
2. Type a message.
